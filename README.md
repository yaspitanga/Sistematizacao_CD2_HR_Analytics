...
Este repositório contém a implementação do pipeline completo da metodologia **KDD (Knowledge Discovery in Databases)** utilizando PySpark para analisar, agrupar e prever a rotatividade de funcionários (*turnover*).
